...
export default function AboutUs() {
  return (
    <Page className="space-y-4">
      <Page.Header title="About Us" description="Mail Bridge" />
      ...
      <div className="space-y-2">
        ...
        <div>
          ...
          their own backend infrastructure. These users desire a minimalistic system that can seamlessly integrate with
          their frontend, allowing them to communicate with their customers effectively. Traditional email-sending
          solutions often require the setup and maintenance of backend servers, making the process cumbersome and
          time-consuming.
        </div>
      </div>
      ...
      <div className="space-y-2">
        ...
        <div>
          ...
          ensures secure and reliable email delivery while maintaining the utmost privacy and data protection. With Mail
          Bridge, you can focus on engaging with your customers and building meaningful connections, rather than
      ...
      <div className="space-y-2">
        ...
        <ol className="space-y-2">
          <li>
            ...
            hook an API route into your form, allowing you to send emails directly from your frontend application. This
            integration eliminates the need for a dedicated backend and simplifies the email-sending process.
          </li>
          <li>
